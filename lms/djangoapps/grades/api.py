...
def override_subsection_grade(
    ...
    try:
        grade = _PersistentSubsectionGrade.read_grade(
            user_id=user_id,
            usage_key=usage_key
        )
...
def undo_override_subsection_grade(user_id, course_key_or_id, usage_key_or_id, feature=''):
    ...
    if override is not None:
        _ = _PersistentSubsectionGradeOverrideHistory.objects.create(
            override_id=override.id,
            feature=feature,
            action=_PersistentSubsectionGradeOverrideHistory.DELETE
        )
        override.delete()
