...
class GradesService(object):
    ...
    def override_subsection_grade(
        ...
        """
        return api.override_subsection_grade(user_id, course_key_or_id, usage_key_or_id, earned_all=earned_all, earned_graded=earned_graded)
    ...
    def undo_override_subsection_grade(self, user_id, course_key_or_id, usage_key_or_id):
        ...
        """
        return api.undo_override_subsection_grade(user_id, course_key_or_id, usage_key_or_id)
